...
export const GET_ALL_POST_BY_TYPE = '[Posts] GET_ALL_POST_BY_ID'
export const GET_ALL_POST_BY_TYPE_SUCCESS = '[Posts] GET_ALL_POST_BY_ID_SUCCESS'
export const GET_ALL_POST_BY_TYPE_FAIL = '[Posts] GET_ALL_POST_BY_ID_FAIL'
